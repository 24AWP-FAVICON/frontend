...
function Sidebar() {
  ...
  return (
    <div className={`flex ${isOpen ? "w-full" : "w-2/4"} transition-all duration-300`} style={{ height: '100%' }}>
      <div className={`flex flex-col ${isOpen ? "w-2/4" : "w-4/4"} h-full border-r-2 border-gray-300 bg-gray-50 shadow-lg`}>
